...
class AnnotatedClass {
    private static class TypeUtil {
        static final ClassName BINDER = ClassName.get("com.haier.ranghood.api", "ViewBinder");
        static final ClassName PROVIDER = ClassName.get("com.haier.ranghood.api", "ViewFinder");
    }
